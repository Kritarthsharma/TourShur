...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia3JpdGFydGgtc2hhcm1hIiwiYSI6ImNra3NkYTdpMTBkaWcyb3BpZDE1eXFjcHgifQ.hS1iiDZM7DvvyBAjf_47Sw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/streets-v11',
    scrollZoom: false // center: [ 77.63122176003927, 12.938036706702515 ], // lnglat
    // zoom: 16
    // interactive: false
  ...
  var bounds = new mapboxgl.LngLatBounds(); // area that will be displayed on the maps.
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      ...
      offset: 30,
      closeOnClick: false
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")) // content for the popup
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/resetPassword/".concat(params),
              data: {
                password: password,
                confirmPassword: confirmPassword
              }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51ILVYNEcZYRfwMwQR0nP1FTsM94OzKdbpURFSbKzah1Hq5S7M4gX97fLn9IDl4zbixEhuaXyJvPG0WhOiFYMsFd300Bsn2jWVq');
            _context.prev = 1;
            _context.next = 4;
...
var overviewSignupForm = document.querySelector('.formOverview--signup');
...
if (overviewSignupForm) {
  overviewSignupForm.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    setTimeout(function () {
      location.reload();
    }, 2000); // const name = document.getElementById('name').value;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; // e.target is element which was clicked. e.target = #book-tour

  console.log(tourId);
  (0, _stripe.bookTour)(tourId);
});
},{"babel-polyfill":"../../node_modules/babel-polyfill/lib/index.js","./mapbox":"mapbox.js","./signup":"signup.js","./login":"login.js","./forgotPassword":"forgotPassword.js","./resetPassword":"resetPassword.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
