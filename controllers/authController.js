...
exports.isLoggedIn = catchAsync(async (req, res, next) => {
  ...
  if (req.cookies.jwt) {
    ...
    ); // This also needs a callback function but to overcome that we have used promisify module. Basically turning it into a promise function. The jwt.verify is an asynchronous function
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  }); // finds user and also checks if the token time hasn't expired yet
